...
if __name__ == "__main__":
    base_folder = r"C:\\Users\\phili\\Python_Woo_till_Shop"
    input_csv_path = os.path.join(base_folder, "woocommerce_export.csv")
    output_csv_path = os.path.join(base_folder, "shopify_import.csv")
