    ...
    with open(input_file, 'r', encoding='utf-8-sig') as infile:
        ...
        for i, row in enumerate(reader):
            ...
            #        new_row["Inventory policy"] = "shopify"
                ...
                # Gör handle unikt endast för huvudprodukten
