...
def replace_header_and_transform_data(input_file, output_file, mapping, delimiter=',', max_rows=None):
    ...
    # def sanitize_html(value): #TESTA DENNA OCKSÅ OM ALLT INTE KOMMER IN
    #     if not isinstance(value, str) or value.strip() == "":
    #         return ""
    #     value = html.unescape(value)
    #     value = re.sub(r'<.*?>', '', value)
    #     # Byt ut radbrytningar mot synliga \n för att förhindra radbrytning i CSV-rad
    #     value = value.replace('\r\n', '\\n').replace('\n', '\\n')
    #     value = value.replace('"', '""')  # escapa citattecken till dubbelcitat
    ...
    def sanitize_html(value):
        ...
        # Ersätt både riktiga radbrytningar och skrivna '\n' med mellanslag
        value = value.replace('\r\n', ' ').replace('\n', ' ').replace('\\n', ' ')
    ...
    #         return ""
    #     value = html.unescape(value)
    #     value = re.sub(r'<.*?>', '', value)  # ta bort HTML-taggar
    #     value = value.replace('\r\n', '\\n').replace('\n', '\\n')  # synliga \n
    #     value = re.sub(r'\s*\\n\s*', '\\n', value)  # trimma \n med mellanrum
    #     value = value.strip()  # trimma runt hela
    #     return value
...
if __name__ == "__main__":
    ...
    input_csv_path = os.path.join(base_folder, "wooexport3.csv")
...
##############################
#fungerar MEN FORTSÄTT PÅ TEST3
##############################